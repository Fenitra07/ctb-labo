...
<!--       <div class="d-none d-lg-flex social-links align-items-center">
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href=""><span>Nos laboratoires</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
      ...
      <a href="#appointment" class="appointment-btn scrollto"><span class="d-none d-md-inline">Demande de </span> devis</a>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>Centre Technique Biomédical</h1>
      <h2>Pour une biologie professionnelle de proximité</h2>
