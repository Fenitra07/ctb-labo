        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="espacepro.php">Espace Profesionnel</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="blogsante.php">Blog Santé</a></li>
            </ul>
          </div>
...
<!--         <div class="credits">
      ...
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        ...
        <a href="https://www.facebook.com/CTBtana" class="facebook" target="_blank"><i class="bx bxl-facebook"></i></a>
